      ...
      builder:(context, state) =>  Container(
            ...
            alignment: Alignment.center,
              decoration: BoxDecoration(
                color : state.isStarted?AppColors.ontapBorder: AppColors.startBackcolor,
                 border: Border.all(color: state.isStarted? Colors.blue: AppColors.circleBorder.withOpacity(0.9),width: 6),
               shape: BoxShape.circle,
              boxShadow:  [
                
           !state.isStarted?     BoxShadow(
                ...
                alignment: Alignment.center,
                  ...
                  context.read<HomeCubit>().onTapButton();
                    ...
                    child: Icon(Icons.power_settings_new_outlined,size: 60,color: state.isStarted ?AppColors.red: AppColors.white,)) ,
                 ),
